/*
* Title: VESSELS_fk_contacts.sql
* Author: George Maynard
* Contact: george.maynard@noaa.gov
* Date Created: 2023-06-22
* Purpose: This script creates a vessels table for the FVON core database that 
*   relies on foreign keys from a CONTACTS table. The port fields are deployed 
*   as varchars, so no external port table is necessary.
*/  
