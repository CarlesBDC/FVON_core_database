/*
* Title: EQUIPMENT_INVENTORY_fk_funding.sql
* Author: George Maynard
* Contact: george.maynard@noaa.gov
* Date Created: 2023-07-11
* Purpose: This script creates the equipment inventory to store information 
*   about deckboxes, sensors, and any other equipment to be tracked. This version
*   of the table requires a FUNDING table to track program funding sources. 
*/  
